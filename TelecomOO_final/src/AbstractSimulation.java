...
public abstract class AbstractSimulation {
     ...
     */
    public void run() {
        BillingCustomer jim = new BillingCustomer("Jim", 650);
        BillingCustomer mik = new BillingCustomer("Mik", 650);
        BillingCustomer crista = new BillingCustomer("Crista", 415);

        say("jim calls mik...");
        BillingCall c1 = jim.call(mik);
        wait(1);
        say("mik accepts...");
        mik.pickup(c1);
        wait(4);
        ...
        BillingCall c2 = jim.call(crista);
        say("crista accepts...");
        crista.pickup(c2);
        wait(2);
        say("crista hangs up...");
     ...
     */
    abstract protected void report(BillingCustomer c);
